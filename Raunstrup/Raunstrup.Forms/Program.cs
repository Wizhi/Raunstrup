...
namespace Raunstrup.Forms
{
    static class Program
    {
        ...
        static void SetupProducts()
        {
            var products = new[]
            {
                new Product { Name = "Træ 1kg", SalesPrice = 123.4M }, 
                new Product { Name = "Håndværkertime", SalesPrice = 200M }, 
                new Product { Name = "Vindue 20x30cm", SalesPrice = 321.2M }, 
            };
        ...
        static void SetupReports()
        {
            ...
            reports[1].AddReportLine(_company.ProductRepository.Get(3), 1);
            reports[1].AddReportLine(_company.ProductRepository.Get(2), 1);
